...
## Gate 5 — Done
- [ ] This file exists and all six prior gate boxes are ticked

## Gate 6 — Recover
- [ ] git revert HEAD succeeded in dry-run; last commit: <sha>

## Gate 7 — Verify-Reproducible
- [ ] Command (copy-pasteable): <exact string, copy/paste from gate 3>
- [ ] Expected summary: <exact line, including version number + count>
- [ ] Prerequisites: <runtime, e.g. Python 3.11+, `pip install -r requirements.txt`>
- [ ] CI run (if applicable): <green/red on PR #N> — or "no CI yet, reviewer to re-run"
